        ...
        <div className="max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="flex items-center">
              <span className="font-['Playfair_Display'] text-2xl font-bold text-[#0D0D0D]">Luxe</span>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link href="/wishlist" className="p-2 text-[#1F1F1F] hover:text-[#FF6B35] transition-colors">
              <Heart size={20} />
            </Link>

            <Link href={user ? "/account" : "/login"} className="flex items-center gap-2 p-2 text-[#1F1F1F] hover:text-[#FF6B35] transition-colors group">
              <User size={20} fill={user ? "currentColor" : "none"} />
              {!user && <span className="hidden xl:inline text-sm font-medium">Sign In</span>}
            </Link>
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <Link href="/" className="flex items-center">
                  <span className="font-['Playfair_Display'] text-xl font-bold text-[#0D0D0D]">Luxe</span>
                  <span className="font-['Playfair_Display'] text-xl font-bold text-[#FF6B35]">Shop</span>
                </Link>
                <button 
                  onClick={() => setIsMobileMenuOpen(false)}
