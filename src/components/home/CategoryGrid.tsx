      ...
      try {
        ...
        setCategories([
          ...
          },
          {
            ...
            name: "Beauty",
            slug: "beauty",
            image_url: "https://picsum.photos/seed/beauty/400/400",
          },
          {
            id: "4",
            name: "Sports",
            slug: "sports",
            image_url: "https://picsum.photos/seed/sports/400/400",
          },
          {
            id: "5",
            name: "Home",
            slug: "home",
            image_url: "https://picsum.photos/seed/home/400/400",
          },
          {
            id: "6",
            name: "Accessories",
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 py-12 lg:py-20">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
              className="aspect-square bg-[#E8E8E8] rounded-xl animate-pulse"
            />
          ))}
        </div>
      </section>
