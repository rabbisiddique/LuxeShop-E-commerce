      ...
      <div className="flex flex-col justify-center px-6 py-8 sm:px-12 lg:px-24 xl:px-32 overflow-y-auto relative">
        ...
        >
          ...
          <form onSubmit={handleSubmit(handleLogin)} className="space-y-5">
            <div>
              <label className="block text-[13px] font-semibold text-[#4B4B4B] mb-2">
                Email Address
              </label>
              ...
              {errors.email && (
                <p className="text-[12px] text-[#DC2626] mt-1.5 font-medium">
          ...
          <div className="text-center mt-8">
            <p className="text-[11px] text-[#9A9A9A] leading-relaxed">
              ...
              <Link
                href="#"
                className="text-[#4B4B4B] hover:text-[#FF6B35] transition-colors"
              >
                Terms of Service
              </Link>{" "}
              and{" "}
            ...
            >
              ...
              {resetSuccess ? (
                ...
                >
                  ...
                  <h3 className="text-[16px] font-bold text-[#16A34A] mb-1">
                    Check your email
                  </h3>
