    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-display font-bold text-neutral-950">Add New Product</h1>
            <p className="text-neutral-500 mt-1">Create a new product listing for your store.</p>
          </div>
        </div>
